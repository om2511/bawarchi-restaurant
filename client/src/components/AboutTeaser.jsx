  ...
  return (
    <section className="bg-cream-100 py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <p className="text-olive-600 text-center sm:text-left font-heading tracking-[0.3em] uppercase text-sm mb-2">Our Story</p>
          <h2 className="font-display text-center sm:text-left text-5xl text-teal-900 mb-5">A Garden of Flavours</h2>
          <p className="text-teal-700/80 text-center sm:text-left leading-relaxed mb-4">
          ...
          <p className="text-teal-700/80 text-center sm:text-left leading-relaxed mb-8">
          ...
          <motion.div className="flex justify-center sm:justify-start" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
            <Link
              to="/about"
